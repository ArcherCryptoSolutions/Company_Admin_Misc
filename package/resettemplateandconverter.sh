...
mkdir -p ~/Mahihkan/package ~/Mahihkan/assets ~/Mahihkan/logs

# create the reset script (writes template + converter)
cat > ~/Mahihkan/package/reset_template_and_converter.sh <<'SH'
#!/usr/bin/env bash
...
chmod +x ~/Mahihkan/package/reset_template_and_converter.sh

# run it
~/Mahihkan/package/reset_template_and_converter.sh
